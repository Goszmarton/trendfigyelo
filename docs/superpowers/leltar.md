...
- **c) INVARIÁNS (frissítéskor ellenőrizd):**
  ...
  Most: **33 + 12 + 10 + 1 = 56**. A **LEZÁRT / ELAVULT** külön számolódik: most **10**.
...
| 6b | nem-órás (nap/het) megjelenítés a felületen | Ph4 | RÉSZBEN (LESZÁLLT: RACS-EGYSEG felirat + RAJZOLÁS-Szelet1 [racs_epit slot-index] + RAJZOLÁS-Szelet2 = a másodlagos JSON FOGYASZTÁSA + egyesitett_reg per-intervallum routing [1_het órás, 2_het+ másodlagos] + rács-tudatos üres-állapot [nincs_masodlagos/esemenyjelzo, NEM 'összefűzött nap'] + részleges-betöltés/elavultság-guard; kód-kész és tesztelt [75 e2e], subagent-review; a ZÁRÓ KAPU a VIZUÁLIS SZEMLE — utána LESZÁLLÍTVA; HÁTRA külön tétel: 6c szint-vonal) | BECS | nem (frontend) | L | 6a valós adat |
...
## (D) Ma (2026-08-13..16) nyitott új tételek (16 — 6 nyitott + 10 rekord)
...
| ALAPNEZET-VEGYES | a leghosszabb-érvényes alap-intervallum (spec 7.2 „magától tolódik kifelé") miatt a kártyák VEGYES kezdő-nézeten nyílnak: a másodlagos adatú szavak a hosszú intervallumon (3_ho/1_ev), a többi 1_het-en. Nem hiba (commitolt spec-szándék, jóváhagyva), de látható inkonzisztencia; ha zavaró, külön kis szeletben 1_het-re rögzíthető | Ph4 | REKORD (megfigyelés) | MÉRT (08-16) | nem (megjel.) | S | 6b |
