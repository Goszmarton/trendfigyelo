...
# LANC-ORAS: az órás 2_het+ a perzisztens kulcsszo_lanc.json-ból szeletel (lásd _intervallumok). A Szelet 2
# (2026-08-21) FELOLDOTTA a megjelenítési GATE-et: a frontend most a láncból rajzolja a 2_het+ pontjait
# (egyesitett_reg → _forras kulcsszo_lanc.json; app.js). ERVENYES-ROUTING: az ervenyes flag a frontend
# elágazását vezérli, a forrás-fájlt a frontend intervallum-hossz alapján dönti (RACS_ABLAK_NAP["ora"]==7).
